...
export const architectureLayers: ArchitectureLayer[] = [
  ...
  },
  {
    ...
    label: 'Place Layer',
    title: 'Place Context',
    description: 'Interprets terrain, weather, activity windows, access needs, and operational constraints.',
    tone: 'signal',
  ...
  },
  {
    ...
    description: 'Compares guest readiness with live place conditions to identify the right level of guidance.',
    tone: 'confidence',
...
export const ranchSignalGroups: RanchSignalGroup[] = [
  ...
  },
  {
    ...
    tone: 'confidence',
    confidenceImpact: 'Adds trust when context needs lived local expertise.',
...
export const ranchArchitectureFlow: RanchArchitectureItem[] = [
  {
    ...
    description: 'Translate live place and operational signals into a clear picture of what matters for this guest now.',
    tone: 'signal',
    badges: ['Sensemaking'],
  },
  {
  ...
  },
  {
    id: 'human-action',
    title: 'Validation',
    description: 'Staff or guides confirm local context while the guest retains authority to join, delay, adapt, or choose another experience.',
    tone: 'ranch',
    badges: ['Human validation'],
  },
];
...
export const activityConfidenceDimensions: ActivityConfidenceDimension[] = [
  ...
  },
  {
    ...
    guidanceResponse: 'Move the guest into a recovery path with an equivalent place-based learning experience.',
  },
];
...
export const activityConfidenceMatrix: ActivityConfidenceMatrixItem[] = [
  ...
  },
  {
    ...
    logisticalComplexity: 'High',
    recoveryFlexibility: 'Medium',
    primaryUncertainty: 'Water, wind, and ability fit',
    supportNeed: 'Conditions briefing and equipment fit',
  },
  {
    id: 'archery',
    ...
    logisticalComplexity: 'Medium',
    recoveryFlexibility: 'Medium',
    primaryUncertainty: 'Sightings, timing, and patience',
    supportNeed: 'Expectation and stewardship framing',
  },
  {
    id: 'wildlife-tour',
    activity: 'Guided Place Tour',
    skillLevel: 'Low barrier',
    intensity: 'Low',
    exposure: 'Low',
    ...
    primaryUncertainty: 'Relevance and group fit',
    supportNeed: 'Local context and pacing choices',
  },
  {
    id: 'ranch-workshop',
    activity: 'Outdoor Wellness',
    skillLevel: 'Low barrier',
    intensity: 'Low',
    exposure: 'Low',
    weatherSensitivity: 'Low',
    ...
    logisticalComplexity: 'Low',
    recoveryFlexibility: 'High',
    primaryUncertainty: 'Comfort, privacy, and pace',
    supportNeed: 'Choice-preserving orientation',
  },
  {
    id: 'campfire-gathering',
    activity: 'Conservation Activity',
    skillLevel: 'Low barrier',
    ...
    logisticalComplexity: 'Medium',
    recoveryFlexibility: 'Medium',
    primaryUncertainty: 'Role, impact, and etiquette',
    supportNeed: 'Stewardship context and staff validation',
  },
];
...
export const guestConfidenceBreakdowns: GuestConfidenceBreakdown[] = [
  {
    ...
    reducer: 'Unclear first steps make the destination feel larger and less legible than it is.',
...
export const weatherScenarioSteps: WeatherScenarioStep[] = [
  ...
  },
  {
    ...
    description: 'Staff validates current trail conditions and confirms which alternatives still feel authentic to the place.',
...
export const guidanceArchitectureFlow: GuidanceArchitectureFlowItem[] = [
  ...
  },
  {
    ...
    description: 'The system chooses whether to clarify, confirm, recommend, delay, reframe, or request human validation.',
    tone: 'stewardship',
  },
  {
    id: 'guest-decision',
    ...
    moments: [
      {
        id: 'match',
        title: 'Match fit',
        description: 'Compares guest readiness with live activity and place conditions.',
        meta: 'Assess',
      },
      {
        id: 'explain',
...
export const operationsBlueprintStages: OperationsBlueprintStage[] = [
  {
    ...
    stage: 'Arrival',
    title: 'Arrival',
    description: 'Guest enters the destination and needs orientation to place, timing, and first steps.',
    type: 'orientation',
...
export const operationsBlueprintMoments: OperationsBlueprintMoment[] = [
  {
    ...
    type: 'objective',
    confidenceImpact: 'Initial confidence rises when the destination feels legible.',
  },
  {
...
export const applicationsMatrix: ApplicationsMatrixItem[] = [
  ...
  },
  {
    ...
    environment: 'Glamping Properties',
    guestUncertainty: 'How do I balance comfort, outdoor exposure, and changing site conditions?',
    operationalComplexity: 'High',
    environmentalVariability: 'Medium',
    stewardshipSensitivity: 'High',
    recoveryImportance: 'High',
    confidenceOpportunity: 'Connect site readiness, comfort expectations, access, and fallback options.',
  },
  {
  ...
  },
  {
    ...
    environment: 'Guided Adventure Operators',
...
export const applications: ApplicationData[] = [
  ...
  },
  {
    ...
    uncertainty: 'Repeated guest hesitation reveals where the place-based experience needs better framing.',
