    ...
    <div className="flex items-center justify-center lg:justify-end w-full h-full min-h-[500px] [perspective:1000px]">
      ...
      >
        <svg viewBox="0 0 520 520" className="w-full h-auto block overflow-visible" preserveAspectRatio="xMidYMid meet">
          ...
          <motion.line x1="260" y1="150" x2="260" y2="220" stroke={colors.activeLine} strokeWidth="2" initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 1.2, delay: 0.2 }} />
          <motion.line x1="190" y1="260" x2="110" y2="260" stroke={colors.line} strokeWidth="1.5" strokeDasharray="4 4" initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 1, delay: 0.8 }} />
          <motion.line x1="330" y1="260" x2="410" y2="260" stroke={colors.line} strokeWidth="1.5" strokeDasharray="4 4" initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 1, delay: 0.8 }} />
          <motion.line x1="260" y1="300" x2="260" y2="380" stroke={colors.line} strokeWidth="1.5" strokeDasharray="4 4" initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 1, delay: 1.0 }} />
