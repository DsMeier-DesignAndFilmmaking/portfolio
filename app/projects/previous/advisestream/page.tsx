    ...
    <main className="min-h-screen bg-black text-white" style={{ paddingTop: 0, marginTop: 0 }}>
      ...
      <section className="relative h-[80vh] flex items-center" aria-label="Project Hero" style={{ marginTop: 0, paddingTop: 0, top: 0 }}>
        ...
        <div className="container mx-auto px-6 relative z-20">
          ...
          >
            <div className="mb-6">
              <ProjectBreadcrumb projectId="advisestream" onDark />
            </div>
      ...
      <section className="py-20 bg-black">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <StatCard icon={FaUsers} value={project.stats.users} label="" />
            <StatCard icon={FaChartLine} value={project.stats.countries} label="" />
            <StatCard icon={FaCheckCircle} value={project.stats.impact} label="" />
          </div>
        </div>
      </section>
          ...
          <div className="space-y-4 max-w-4xl">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-white mb-1">Mobile Designs PDF</h3>
                  <p className="text-gray-400 text-sm">Complete mobile design flows and wireframes for AdviseStream.</p>
                </div>
              </div>
